...
<img width="1792" alt="Снимок экрана 2024-05-25 в 02 14 09" src="https://github.com/danikd1/OS_IHW3/assets/36849026/3c344389-f594-4137-9525-8636412971f3">
При подключении к серверу мы получаем начальные значения в базе данных, хранящейся в разделяемой памяти, которые будцт использоваться клиентами для операций чтения и записи.
Так же выводится информация по какому IP-адресу и порту работает сервер. Если сервер принял подключение от клиента и создал дочерний процесс для обработки этого клиента, то выводится идентификатор (PID) дочернего процесса. 
Перед отправкой информации клиенту на серевер выводится сформированный ответ для проверки корректности данных.
При отключении клиента так же выводится на сервер информация. 
<img width="1792" alt="Снимок экрана 2024-05-25 в 02 14 54" src="https://github.com/danikd1/OS_IHW3/assets/36849026/7b6b355c-6db7-4ec8-b491-549074de1e6b">
<img width="1791" alt="Снимок экрана 2024-05-25 в 02 15 31" src="https://github.com/danikd1/OS_IHW3/assets/36849026/21ae42a1-2172-48a0-b5f8-d538edb4921f">

**6-7 баллов** - ihw_v2
Реализованна отдельная клиентская программа, подключаемая к серверу, которая отображает комплексную информации о выполнении приложения. Данный программный модуль отображает поведение моделируемой системы в целом (информацию передаваемую на сервер и информацию, порождаемую сервером), позволяя не пользоваться отдельными видами, предоставляемыми клиентами и серверами по отдельности.
<img width="1776" alt="Снимок экрана 2024-05-25 в 02 38 03" src="https://github.com/danikd1/OS_IHW3/assets/36849026/0993942e-5b00-494b-be69-b8bb00964b48">
